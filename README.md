...
permanent instructions plus fifteen single-purpose weekly tasks — that you drop
...
- **One task, one job.** Instead of one giant prompt, fifteen small ones. Each is
...
tasks/
  README.md                   # the 15 tasks, what each answers, suggested cadence
  task-01-weekly-news.md … task-15-civic-profile.md
hosting/
